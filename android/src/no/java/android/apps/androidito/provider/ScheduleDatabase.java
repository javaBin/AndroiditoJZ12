...
import no.java.android.apps.androidito.provider.ScheduleContract.AnnouncementsColumns;
import no.java.android.apps.androidito.provider.ScheduleContract.Blocks;
import no.java.android.apps.androidito.provider.ScheduleContract.BlocksColumns;
import no.java.android.apps.androidito.provider.ScheduleContract.Rooms;
import no.java.android.apps.androidito.provider.ScheduleContract.RoomsColumns;
import no.java.android.apps.androidito.provider.ScheduleContract.Sessions;
import no.java.android.apps.androidito.provider.ScheduleContract.SessionsColumns;
import no.java.android.apps.androidito.provider.ScheduleContract.Speakers;
import no.java.android.apps.androidito.provider.ScheduleContract.SpeakersColumns;
...
import no.java.android.apps.androidito.provider.ScheduleContract.TracksColumns;
import no.java.android.apps.androidito.provider.ScheduleContract.Vendors;
import no.java.android.apps.androidito.provider.ScheduleContract.VendorsColumns;
...
import static no.java.android.apps.androidito.util.LogUtils.LOGW;
