...
package no.java.android.apps.androidito.provider;

import no.java.android.apps.androidito.provider.ScheduleContract.Announcements;
import no.java.android.apps.androidito.provider.ScheduleContract.Blocks;
import no.java.android.apps.androidito.provider.ScheduleContract.Rooms;
import no.java.android.apps.androidito.provider.ScheduleContract.SearchSuggest;
import no.java.android.apps.androidito.provider.ScheduleContract.Sessions;
import no.java.android.apps.androidito.provider.ScheduleContract.Speakers;
import no.java.android.apps.androidito.provider.ScheduleContract.Tracks;
import no.java.android.apps.androidito.provider.ScheduleContract.Vendors;
import no.java.android.apps.androidito.provider.ScheduleDatabase.SessionsSearchColumns;
import no.java.android.apps.androidito.provider.ScheduleDatabase.SessionsSpeakers;
import no.java.android.apps.androidito.provider.ScheduleDatabase.SessionsTracks;
import no.java.android.apps.androidito.provider.ScheduleDatabase.Tables;
import no.java.android.apps.androidito.util.SelectionBuilder;
...
import static no.java.android.apps.androidito.util.LogUtils.LOGV;
 ...
 * by {@link no.java.android.apps.androidito.sync.SyncHelper}, and queried by various
