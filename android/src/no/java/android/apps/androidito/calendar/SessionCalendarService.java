...
package no.java.android.apps.androidito.calendar;
...
public class SessionCalendarService extends IntentService {
    ...
    public static final String ACTION_ADD_SESSION_CALENDAR =
            "no.java.android.apps.androidito.action.ADD_SESSION_CALENDAR";
    public static final String ACTION_REMOVE_SESSION_CALENDAR =
            "no.java.android.apps.androidito.action.REMOVE_SESSION_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR =
            "no.java.android.apps.androidito.action.UPDATE_ALL_SESSIONS_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR_COMPLETED =
            "no.java.android.apps.androidito.action.UPDATE_CALENDAR_COMPLETED";
    public static final String ACTION_CLEAR_ALL_SESSIONS_CALENDAR =
            "no.java.android.apps.androidito.action.CLEAR_ALL_SESSIONS_CALENDAR";
    public static final String EXTRA_ACCOUNT_NAME =
            "no.java.android.apps.androidito.extra.ACCOUNT_NAME";
    public static final String EXTRA_SESSION_BLOCK_START =
            "no.java.android.apps.androidito.extra.SESSION_BLOCK_START";
    public static final String EXTRA_SESSION_BLOCK_END =
            "no.java.android.apps.androidito.extra.SESSION_BLOCK_END";
    public static final String EXTRA_SESSION_TITLE =
            "no.java.android.apps.androidito.extra.SESSION_TITLE";
    public static final String EXTRA_SESSION_ROOM =
            "no.java.android.apps.androidito.extra.SESSION_ROOM";
     ...
     * {@link no.java.android.apps.androidito.provider.ScheduleProvider}, adding or removing
