...
package no.java.android.apps.androidito.appwidget;

import no.java.android.apps.androidito.R;
import no.java.android.apps.androidito.provider.ScheduleContract;
import no.java.android.apps.androidito.ui.HomeActivity;
import no.java.android.apps.androidito.ui.SessionLivestreamActivity;
...
public class MyScheduleWidgetProvider extends AppWidgetProvider {
    ...
    public static final String CLICK_ACTION =
            "no.java.android.apps.androidito.appwidget.action.CLICK";
    public static final String REFRESH_ACTION =
            "no.java.android.apps.androidito.appwidget.action.REFRESH";
    public static final String EXTRA_PERFORM_SYNC =
            "no.java.android.apps.androidito.appwidget.extra.PERFORM_SYNC";
